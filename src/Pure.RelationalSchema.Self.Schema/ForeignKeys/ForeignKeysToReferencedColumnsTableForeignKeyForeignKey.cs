...
public sealed record ForeignKeysToReferencedColumnsTableForeignKeyForeignKey : IForeignKey
{
    public ITable ReferencingTable => new ForeignKeysToReferencedColumnsTable();
